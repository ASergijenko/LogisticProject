...
public class DesignationSmallContainerBordersTest {
    ...
    public void designateBordersZeroX() {
        ...
        Assert.assertEquals(new Point(TwentyFootContainer.WIDTH - 50, 20), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
    ...
    public void designateBordersHigherTPNK_2_BetweenKSTK() {
        ...
        Assert.assertEquals(new Point(TwentyFootContainer.WIDTH - 15, 10), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
    ...
    public void designateBordersHigherTPNK_2() {
        ...
        Assert.assertEquals(new Point(TwentyFootContainer.WIDTH - 30, 20), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
    ...
    public void designateBordersBelowTPNK_2() {
        ...
        Assert.assertEquals(new Point(5, 10), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
    ...
    public void designateBordersBelowTPNK_2BetweenKSTK() {
        ...
        Assert.assertEquals(new Point(10, 5), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
    ...
    public void designateBordersZeroY() {
        ...
        Assert.assertEquals(new Point(20, (TwentyFootContainer.LENGTH + 1) - 60), victim.designateBorders(pointList, TPMK_point, TPMK_2_point));
    }
}